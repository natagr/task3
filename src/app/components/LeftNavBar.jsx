...
const menuItems = [
    ...
    {
        icon: <IconLockOpen/>,
        link: `${pagesURLs[pages.courseListPage]}`,
        neededAuthorities: [authorities.ENABLE_SEE_SECRET_PAGE],
        titleIntlId: `page.${pages.courseListPage}`,
    },
];
...
function LeftNavBar() {
    ...
    const filteredItems = useMemo(
        () => menuItems.filter(item => !item.neededAuthorities || accessValidate(item.neededAuthorities)),
        [accessValidate],
    );
